                ...
                children: [
                  Row(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('${tech!.firstname} ${tech!.lastname}', style: TextStyle(color: mainBlackColorTheme, fontSize: 18, fontFamily: PoppinsFamily),),
                                Padding(
                                  padding: const EdgeInsets.fromLTRB(0.0, 6.0, 0.0, 0.0),
                                  child: Text(lbl_Personal_Info, style: TextStyle(color: mainGreyColorTheme, fontSize: 14, fontFamily: PoppinsFamily),),
                                ),
                              ],
                            ),
                          ),
                      ...
                      Spacer(),
                      Icon(Icons.edit, color: mainGreyColorTheme,),
                    ],
                  ),
                  Row(
                    children: [
                      Expanded(child: Divider(color: lightBorderColor,)),
                    ],
                  ),
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: SubTitleText(title: lbl_Notifications,),
                        ),
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.fromLTRB(0.0, 10.0, 0.0, 0.0),
                          child: SubTitleText(title: lbl_Language,),
                        ),
                        GestureDetector(
                          onTap: (){},
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                Padding(
                                  ...
                                  child: Text('English', style: TextStyle(color: mainGreyColorTheme, fontSize: 14, fontFamily: PoppinsFamily),),
                                ),
                                Container(
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.fromLTRB(0.0, 10.0, 0.0, 0.0),
                          child: SubTitleText(title: lbl_Privacy,),
                        ),
                        GestureDetector(
                          onTap: (){
