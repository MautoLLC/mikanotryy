      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            text('Please enter the address associated', fontFamily: "Poppin", fontSize: 15.0, textColor: mainGreyColorTheme),
            text('with your account.', fontFamily: "Poppin", fontSize: 15.0, textColor: mainGreyColorTheme),
