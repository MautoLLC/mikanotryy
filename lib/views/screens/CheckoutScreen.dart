                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border(
                              bottom: BorderSide(
                                  color: lightBorderColor, width: 1.0))),
                      child: Row(
                        children: [
                          ImageBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: TextStyle(
                                      fontSize: 14, color: mainBlackColorTheme),
                                ),
                                SizedBox(height: 11),
                                Text(
                                  state.ChosenAddress.address1.toString(),
                                  style: TextStyle(
                                      fontSize: 14, color: mainGreyColorTheme),
                                ),
                              ],
                            ),
                          ),
                    ...
                    T13Button(
                        ...
                        onPressed: () async {
                          if (state.termsAccepted) {
                            ...
                            toast("Terms and services checkbox is unchecked");
                          }
                        }),
                    SizedBox(height: 20.0),
                  ],
