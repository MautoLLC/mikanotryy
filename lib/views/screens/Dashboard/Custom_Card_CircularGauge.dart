...
class Custom_Card_CircularGuage extends StatelessWidget {
  ...
  String Unit;
  String Value ;
  Custom_Card_CircularGuage({required this.Icon,required this.Description,required this.Unit,required this.Value});
  @override
...
child: Padding(
  ...
  child: Column(
    children: [
      ...
      ranges: <GaugeRange>[
      GaugeRange(startValue: 0,endValue: 30,color: Colors.green,startWidth: 15,endWidth: 20),
      GaugeRange(startValue: 30,endValue: 70,color: Colors.orange,startWidth: 20,endWidth: 30),
      GaugeRange(startValue: 70,endValue: 100,color: Colors.red,startWidth: 30,endWidth: 35)],
    pointers: <GaugePointer>[NeedlePointer(value:double.parse(Value),tailStyle: TailStyle(width: 8, length: 0.2))],
