                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: commonCacheImageWidget(
                        widget.mainCatg.maintenanceCategoryIcon, 48),
                  ),
                ),
                Padding(
                                    ...
                                    child: Padding(
                                      ...
                                      child: DropdownButton(
                                        ...
                                        items: address2.realEstates!
                                            ...
                                            .toList(),
                                        onChanged:
                                            (RealEstatesViewModel? value) {
                                          setState(() {
                                            selectedAddressValue = value!
                                                .mrealEstate!.realEstateAddress;
                                          });
                                        },
                                      ),
                                    ),
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          "${DateTime.now().month.toMonthName()} ${DateTime.now().day}, ${DateTime.now().year}",
                                          style: TextStyle(
                                            fontSize: 12,
                                            fontFamily: PoppinsFamily,
                                            color: mainGreyColorTheme,
                                ...
                                MaintenanceRequestModel mMaintenanceRequest =
                                    new MaintenanceRequestModel(
                                        maintenanceCategoryId:
                                            selectedSubCategId,
                                        realEstateId: address2.realEstates!
                                            .where((element) =>
                                                element.mrealEstate!
                                                    .realEstateAddress ==
                                                selectedAddressValue)
