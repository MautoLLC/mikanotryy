                  ...
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(child: Text("Decline", style: TextStyle(color: Colors.white, fontSize: 18, fontFamily: PoppinsFamily))),
                      ),
                    ),
                  ),
                  SizedBox(width: 10),
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(child: Text("Accept", style: TextStyle(color: Colors.white, fontSize: 18, fontFamily: PoppinsFamily))),
                      ),
                    ),
                  )
                ],
