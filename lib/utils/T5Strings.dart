...
const t5_maintenance = " Maintenance";
const t5_maintenance_repair = "Maintenance & Repair";
const t5_quotations= " Quotations";
const t5_mikano_shop = "MIKANO Shop";
const t5_view_all = "View all";
const t5_services = "Divisions and Services";
const t5_shopping = "Shopping Cart";
const t5_profile = "Profile";
const t5_notifications = "Notifications";